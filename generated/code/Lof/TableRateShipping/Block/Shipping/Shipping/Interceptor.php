<?php
namespace Lof\TableRateShipping\Block\Shipping\Shipping;

/**
 * Interceptor class for @see \Lof\TableRateShipping\Block\Shipping\Shipping
 */
class Interceptor extends \Lof\TableRateShipping\Block\Shipping\Shipping implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Framework\Data\Helper\PostHelper $postDataHelper, \Magento\Framework\Url\Helper\Data $urlHelper, \Magento\Customer\Model\Customer $customer, \Magento\Customer\Model\Session $session, \Lof\TableRateShipping\Model\ShippingmethodFactory $shippingmethodFactory, \Magento\Directory\Model\ResourceModel\Country\CollectionFactory $countryCollectionFactory, \Lof\TableRateShipping\Model\ShippingFactory $mpshippingModel, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $postDataHelper, $urlHelper, $customer, $session, $shippingmethodFactory, $countryCollectionFactory, $mpshippingModel, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getShippingId');
        if (!$pluginInfo) {
            return parent::getShippingId();
        } else {
            return $this->___callPlugins('getShippingId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getShipping');
        if (!$pluginInfo) {
            return parent::getShipping($shipping_id);
        } else {
            return $this->___callPlugins('getShipping', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getShippingCollection');
        if (!$pluginInfo) {
            return parent::getShippingCollection($partnerId);
        } else {
            return $this->___callPlugins('getShippingCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getShippingMethodCollection');
        if (!$pluginInfo) {
            return parent::getShippingMethodCollection();
        } else {
            return $this->___callPlugins('getShippingMethodCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getShippingforShippingMethod');
        if (!$pluginInfo) {
            return parent::getShippingforShippingMethod($methodId, $partnerId);
        } else {
            return $this->___callPlugins('getShippingforShippingMethod', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getShippingMethodName');
        if (!$pluginInfo) {
            return parent::getShippingMethodName($shippingMethodId);
        } else {
            return $this->___callPlugins('getShippingMethodName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCountryOptionArray');
        if (!$pluginInfo) {
            return parent::getCountryOptionArray();
        } else {
            return $this->___callPlugins('getCountryOptionArray', func_get_args(), $pluginInfo);
        }
    }
