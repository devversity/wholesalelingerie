...
class Interceptor extends \Magento\Wishlist\Model\Wishlist implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function loadByCustomerId($customerId, $create = false)
    {
        ...
        if (!$pluginInfo) {
            return parent::loadByCustomerId($customerId, $create);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'generateSharingCode');
        if (!$pluginInfo) {
            return parent::generateSharingCode();
        } else {
            return $this->___callPlugins('generateSharingCode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addNewItem');
        if (!$pluginInfo) {
            return parent::addNewItem($product, $buyRequest, $forciblySetQty);
        } else {
            return $this->___callPlugins('addNewItem', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDataForSave');
        if (!$pluginInfo) {
            return parent::getDataForSave();
        } else {
            return $this->___callPlugins('getDataForSave', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setSharedStoreIds');
        if (!$pluginInfo) {
            return parent::setSharedStoreIds($storeIds);
        } else {
            return $this->___callPlugins('setSharedStoreIds', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isOwner');
        if (!$pluginInfo) {
            return parent::isOwner($customerId);
        } else {
            return $this->___callPlugins('isOwner', func_get_args(), $pluginInfo);
        }
    }
