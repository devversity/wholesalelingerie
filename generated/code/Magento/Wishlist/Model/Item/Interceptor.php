...
class Interceptor extends \Magento\Wishlist\Model\Item implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function loadByProductWishlist($wishlistId, $productId, $sharedStores)
    {
        ...
        if (!$pluginInfo) {
            return parent::loadByProductWishlist($wishlistId, $productId, $sharedStores);
        } else {
            return $this->___callPlugins('loadByProductWishlist', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function mergeBuyRequest($buyRequest)
    {
        ...
        if (!$pluginInfo) {
            return parent::mergeBuyRequest($buyRequest);
        } else {
            return $this->___callPlugins('mergeBuyRequest', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setBuyRequest($buyRequest)
    {
        ...
        if (!$pluginInfo) {
            return parent::setBuyRequest($buyRequest);
        } else {
            return $this->___callPlugins('setBuyRequest', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isRepresent($product, $buyRequest)
    {
        ...
        if (!$pluginInfo) {
            return parent::isRepresent($product, $buyRequest);
        } else {
            return $this->___callPlugins('isRepresent', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function canHaveQty()
    {
        ...
        if (!$pluginInfo) {
            return parent::canHaveQty();
        } else {
            return $this->___callPlugins('canHaveQty', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCustomDownloadUrl()
    {
        ...
        if (!$pluginInfo) {
            return parent::getCustomDownloadUrl();
        } else {
            return $this->___callPlugins('getCustomDownloadUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setCustomDownloadUrl($url)
    {
        ...
        if (!$pluginInfo) {
            return parent::setCustomDownloadUrl($url);
        } else {
            return $this->___callPlugins('setCustomDownloadUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function loadWithOptions($id, $optionsFilter = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::loadWithOptions($id, $optionsFilter);
        } else {
            return $this->___callPlugins('loadWithOptions', func_get_args(), $pluginInfo);
        }
    }
