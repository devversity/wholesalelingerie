...
class Interceptor extends \Magento\Customer\Model\AccountManagement implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function createAccount(\Magento\Customer\Api\Data\CustomerInterface $customer, $password = null, $redirectUrl = '', $extensions = array())
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'createAccount');
        if (!$pluginInfo) {
            return parent::createAccount($customer, $password, $redirectUrl, $extensions);
        } else {
     ...
     * {@inheritdoc}
     */
    public function createAccountWithPasswordHash(\Magento\Customer\Api\Data\CustomerInterface $customer, $hash, $redirectUrl = '', $extensions = array())
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'createAccountWithPasswordHash');
        if (!$pluginInfo) {
            return parent::createAccountWithPasswordHash($customer, $hash, $redirectUrl, $extensions);
        } else {
