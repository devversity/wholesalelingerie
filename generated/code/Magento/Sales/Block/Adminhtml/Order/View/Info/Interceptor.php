...
class Interceptor extends \Magento\Sales\Block\Adminhtml\Order\View\Info implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getOrderStoreName()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getOrderStoreName', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCustomerGroupName()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getCustomerGroupName', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCustomerViewUrl()
    {
        ...
        if (!$pluginInfo) {
            return parent::getCustomerViewUrl();
        } else {
            return $this->___callPlugins('getCustomerViewUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getViewUrl($orderId)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getViewUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCustomerAccountData()
    {
        ...
        if (!$pluginInfo) {
            return parent::getCustomerAccountData();
        } else {
            return $this->___callPlugins('getCustomerAccountData', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function shouldDisplayCustomerIp()
    {
        ...
        if (!$pluginInfo) {
            return parent::shouldDisplayCustomerIp();
        } else {
            return $this->___callPlugins('shouldDisplayCustomerIp', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCreatedAtStoreDate($store, $createdAt)
    {
        ...
        if (!$pluginInfo) {
            return parent::getCreatedAtStoreDate($store, $createdAt);
        } else {
            return $this->___callPlugins('getCreatedAtStoreDate', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getTimezoneForStore($store)
    {
        ...
        if (!$pluginInfo) {
            return parent::getTimezoneForStore($store);
        } else {
            return $this->___callPlugins('getTimezoneForStore', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getOrderAdminDate($createdAt)
    {
        ...
        if (!$pluginInfo) {
            return parent::getOrderAdminDate($createdAt);
        } else {
            return $this->___callPlugins('getOrderAdminDate', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getFormattedAddress(\Magento\Sales\Model\Order\Address $address)
    {
        ...
        if (!$pluginInfo) {
            return parent::getFormattedAddress($address);
        } else {
    ...
    public function getOrderTotalData()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getOrderTotalData', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getOrderInfoData()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getOrderInfoData', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function displayShippingPriceInclTax($order)
    {
        ...
        if (!$pluginInfo) {
            return parent::displayShippingPriceInclTax($order);
        } else {
            return $this->___callPlugins('displayShippingPriceInclTax', func_get_args(), $pluginInfo);
        }
    }
