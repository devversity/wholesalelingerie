...
class Interceptor extends \Magento\Sales\Block\Adminhtml\Order\Create\Totals\Shipping implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'displayBoth');
        if (!$pluginInfo) {
            return parent::displayBoth();
        } else {
            return $this->___callPlugins('displayBoth', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'displayIncludeTax');
        if (!$pluginInfo) {
            return parent::displayIncludeTax();
        } else {
            return $this->___callPlugins('displayIncludeTax', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getShippingIncludeTax');
        if (!$pluginInfo) {
            return parent::getShippingIncludeTax();
        } else {
            return $this->___callPlugins('getShippingIncludeTax', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getShippingExcludeTax');
        if (!$pluginInfo) {
            return parent::getShippingExcludeTax();
        } else {
            return $this->___callPlugins('getShippingExcludeTax', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIncludeTaxLabel');
        if (!$pluginInfo) {
            return parent::getIncludeTaxLabel();
        } else {
            return $this->___callPlugins('getIncludeTaxLabel', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getExcludeTaxLabel');
        if (!$pluginInfo) {
            return parent::getExcludeTaxLabel();
        } else {
            return $this->___callPlugins('getExcludeTaxLabel', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderTotal');
        if (!$pluginInfo) {
            return parent::renderTotal($total, $area, $colspan);
        } else {
            return $this->___callPlugins('renderTotal', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderTotals');
        if (!$pluginInfo) {
            return parent::renderTotals($area, $colspan);
        } else {
            return $this->___callPlugins('renderTotals', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canSendNewOrderConfirmationEmail');
        if (!$pluginInfo) {
            return parent::canSendNewOrderConfirmationEmail();
        } else {
            return $this->___callPlugins('canSendNewOrderConfirmationEmail', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNoteNotify');
        if (!$pluginInfo) {
            return parent::getNoteNotify();
        } else {
            return $this->___callPlugins('getNoteNotify', func_get_args(), $pluginInfo);
        }
    }
