...
class Interceptor extends \Magento\Sales\Block\Adminhtml\Order\Create\Billing\Method\Form implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'hasMethods');
        if (!$pluginInfo) {
            return parent::hasMethods();
        } else {
            return $this->___callPlugins('hasMethods', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'hasSsCardType');
        if (!$pluginInfo) {
            return parent::hasSsCardType();
        } else {
            return $this->___callPlugins('hasSsCardType', func_get_args(), $pluginInfo);
        }
    }
