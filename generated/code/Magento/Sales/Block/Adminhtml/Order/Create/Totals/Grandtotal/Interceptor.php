...
class Interceptor extends \Magento\Sales\Block\Adminhtml\Order\Create\Totals\Grandtotal implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'includeTax');
        if (!$pluginInfo) {
            return parent::includeTax();
        } else {
            return $this->___callPlugins('includeTax', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTotalExclTax');
        if (!$pluginInfo) {
            return parent::getTotalExclTax();
        } else {
            return $this->___callPlugins('getTotalExclTax', func_get_args(), $pluginInfo);
        }
    }
