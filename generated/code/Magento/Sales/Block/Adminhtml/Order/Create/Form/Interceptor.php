...
class Interceptor extends \Magento\Sales\Block\Adminhtml\Order\Create\Form implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLoadBlockUrl');
        if (!$pluginInfo) {
            return parent::getLoadBlockUrl();
        } else {
            return $this->___callPlugins('getLoadBlockUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCustomerSelectorDisplay');
        if (!$pluginInfo) {
            return parent::getCustomerSelectorDisplay();
        } else {
            return $this->___callPlugins('getCustomerSelectorDisplay', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStoreSelectorDisplay');
        if (!$pluginInfo) {
            return parent::getStoreSelectorDisplay();
        } else {
            return $this->___callPlugins('getStoreSelectorDisplay', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDataSelectorDisplay');
        if (!$pluginInfo) {
            return parent::getDataSelectorDisplay();
        } else {
            return $this->___callPlugins('getDataSelectorDisplay', func_get_args(), $pluginInfo);
        }
    }
