...
class Interceptor extends \Magento\Multishipping\Block\Checkout\Billing implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSelectedMethodCode');
        if (!$pluginInfo) {
            return parent::getSelectedMethodCode();
        } else {
            return $this->___callPlugins('getSelectedMethodCode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getQuoteBaseGrandTotal');
        if (!$pluginInfo) {
            return parent::getQuoteBaseGrandTotal();
        } else {
            return $this->___callPlugins('getQuoteBaseGrandTotal', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSelectAddressUrl');
        if (!$pluginInfo) {
            return parent::getSelectAddressUrl();
        } else {
            return $this->___callPlugins('getSelectAddressUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setMethodFormTemplate');
        if (!$pluginInfo) {
            return parent::setMethodFormTemplate($method, $template);
        } else {
            return $this->___callPlugins('setMethodFormTemplate', func_get_args(), $pluginInfo);
        }
    }
