...
class Interceptor extends \Magento\OfflinePayments\Model\Checkmo implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getPayableTo()
    {
        ...
        if (!$pluginInfo) {
            return parent::getPayableTo();
        } else {
            return $this->___callPlugins('getPayableTo', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getMailingAddress()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getMailingAddress', func_get_args(), $pluginInfo);
        }
    }
