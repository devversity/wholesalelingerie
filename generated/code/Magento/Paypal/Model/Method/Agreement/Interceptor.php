...
class Interceptor extends \Magento\Paypal\Model\Method\Agreement implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function initBillingAgreementToken(\Magento\Paypal\Model\Billing\AbstractAgreement $agreement)
    {
        ...
        if (!$pluginInfo) {
            return parent::initBillingAgreementToken($agreement);
        } else {
            return $this->___callPlugins('initBillingAgreementToken', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getBillingAgreementTokenInfo(\Magento\Paypal\Model\Billing\AbstractAgreement $agreement)
    {
        ...
        if (!$pluginInfo) {
            return parent::getBillingAgreementTokenInfo($agreement);
        } else {
            return $this->___callPlugins('getBillingAgreementTokenInfo', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function placeBillingAgreement(\Magento\Paypal\Model\Billing\AbstractAgreement $agreement)
    {
        ...
        if (!$pluginInfo) {
            return parent::placeBillingAgreement($agreement);
        } else {
            return $this->___callPlugins('placeBillingAgreement', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function updateBillingAgreementStatus(\Magento\Paypal\Model\Billing\AbstractAgreement $agreement)
    {
        ...
        if (!$pluginInfo) {
            return parent::updateBillingAgreementStatus($agreement);
        } else {
            return $this->___callPlugins('updateBillingAgreementStatus', func_get_args(), $pluginInfo);
        }
    }
