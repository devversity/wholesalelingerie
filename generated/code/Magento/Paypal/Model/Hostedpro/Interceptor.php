...
class Interceptor extends \Magento\Paypal\Model\Hostedpro implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getAllowedCcTypes()
    {
        ...
        if (!$pluginInfo) {
            return parent::getAllowedCcTypes();
        } else {
            return $this->___callPlugins('getAllowedCcTypes', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getReturnUrl($storeId = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::getReturnUrl($storeId);
        } else {
            return $this->___callPlugins('getReturnUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getNotifyUrl($storeId = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::getNotifyUrl($storeId);
        } else {
            return $this->___callPlugins('getNotifyUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCancelUrl($storeId = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::getCancelUrl($storeId);
        } else {
