...
class Interceptor extends \WeltPixel\AjaxInfiniteScroll\Block\Product\ListProduct implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'injectAttributeFilters');
        if (!$pluginInfo) {
            return parent::injectAttributeFilters($filters);
        } else {
            return $this->___callPlugins('injectAttributeFilters', func_get_args(), $pluginInfo);
        }
    }
