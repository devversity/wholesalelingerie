...
class Interceptor extends \WeltPixel\OwlCarouselSlider\Block\Slider\Products implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSliderConfiguration');
        if (!$pluginInfo) {
            return parent::getSliderConfiguration();
        } else {
            return $this->___callPlugins('getSliderConfiguration', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBreakpointConfiguration');
        if (!$pluginInfo) {
            return parent::getBreakpointConfiguration();
        } else {
            return $this->___callPlugins('getBreakpointConfiguration', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductCollectionRelated');
        if (!$pluginInfo) {
            return parent::getProductCollectionRelated();
        } else {
            return $this->___callPlugins('getProductCollectionRelated', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getRelatedProducts($currentProduct)
    {
        ...
        if (!$pluginInfo) {
            return parent::getRelatedProducts($currentProduct);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductCollectionUpSell');
        if (!$pluginInfo) {
            return parent::getProductCollectionUpSell();
        } else {
            return $this->___callPlugins('getProductCollectionUpSell', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getUpSellProducts($currentProduct)
    {
        ...
        if (!$pluginInfo) {
            return parent::getUpSellProducts($currentProduct);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductCollectionCrossSell');
        if (!$pluginInfo) {
            return parent::getProductCollectionCrossSell();
        } else {
            return $this->___callPlugins('getProductCollectionCrossSell', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCrossSellProducts($currentProduct)
    {
        ...
        if (!$pluginInfo) {
            return parent::getCrossSellProducts($currentProduct);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isHoverImageEnabled');
        if (!$pluginInfo) {
            return parent::isHoverImageEnabled();
        } else {
            return $this->___callPlugins('isHoverImageEnabled', func_get_args(), $pluginInfo);
        }
    }
