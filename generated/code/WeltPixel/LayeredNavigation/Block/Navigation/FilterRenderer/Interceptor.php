...
class Interceptor extends \WeltPixel\LayeredNavigation\Block\Navigation\FilterRenderer implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\WeltPixel\LayeredNavigation\Helper\Data $wpHelper, \WeltPixel\LayeredNavigation\Model\AttributeOptions $attributeOptions, \Magento\Framework\View\Element\Template\Context $context, array $data = array())
    {
        $this->___init();
    ...
    public function setAttributeId($filter)
    {
        ...
        if (!$pluginInfo) {
            return parent::setAttributeId($filter);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWpAttributeOptions');
        if (!$pluginInfo) {
            return parent::getWpAttributeOptions();
        } else {
            return $this->___callPlugins('getWpAttributeOptions', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getVisibleItems');
        if (!$pluginInfo) {
            return parent::getVisibleItems();
        } else {
            return $this->___callPlugins('getVisibleItems', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getVisibleItemsStep');
        if (!$pluginInfo) {
            return parent::getVisibleItemsStep();
        } else {
            return $this->___callPlugins('getVisibleItemsStep', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getShowQty');
        if (!$pluginInfo) {
            return parent::getShowQty();
        } else {
            return $this->___callPlugins('getShowQty', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIsMultiSelect');
        if (!$pluginInfo) {
            return parent::getIsMultiSelect();
        } else {
            return $this->___callPlugins('getIsMultiSelect', func_get_args(), $pluginInfo);
        }
    }
