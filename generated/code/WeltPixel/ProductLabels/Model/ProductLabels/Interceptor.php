...
class Interceptor extends \WeltPixel\ProductLabels\Model\ProductLabels implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllStoreIdsAssigned');
        if (!$pluginInfo) {
            return parent::getAllStoreIdsAssigned();
        } else {
            return $this->___callPlugins('getAllStoreIdsAssigned', func_get_args(), $pluginInfo);
        }
    }
