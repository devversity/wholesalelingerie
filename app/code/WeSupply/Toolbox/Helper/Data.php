...
class Data extends AbstractHelper
{
    ...
    public function getWeSupplyDomain()
    {
        ...
        $weSupplyDomain = $this->scopeConfig->getValue('wesupply_api/integration/wesupply_domain', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        if ($this->isStagingMode()) {
            return $weSupplyDomain . '/stage';
        }

        return $weSupplyDomain;
    }
    ...
    {
        return $this->scopeConfig->getValue('wesupply_api/step_2/wesupply_subdomain', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    }
    ...
    public function getConnectionStatusByScope()
    {
        ...
        if (isset($params['store'])) {
            return $this->scopeConfig->getValue('wesupply_api/step_1/wesupply_connection_status', ScopeInterface::SCOPE_STORE, $params['store']);
        }
        if (isset($params['website'])) {
            return $this->scopeConfig->getValue('wesupply_api/step_1/wesupply_connection_status', ScopeInterface::SCOPE_WEBSITE, $params['website']);
        }

        return $this->scopeConfig->getValue('wesupply_api/step_1/wesupply_connection_status', 'default');
    }
    ...
    {
        return $this->scopeConfig->getValue('wesupply_api/step_1/wesupply_connection_status', ScopeInterface::SCOPE_STORE);
    }
